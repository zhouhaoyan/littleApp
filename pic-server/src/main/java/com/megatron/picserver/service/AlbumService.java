...
public interface AlbumService extends BaseService<Album,Long> {
    ...
    Album addAlbum(String name, String title, String description, String url, Integer isTop, Integer isBanner, Long classIfyId, List<String> lables,Long userId);
    ...
    boolean updateAlbum(Long id,String name, String title, String description, String url,
     ...
     PageBean<Album> page(Integer status, Long classifyId, Integer isBanner, Integer isTop, Integer pageSize, Integer pageNo);
     List<Album> list(Integer status, Long classifyId, Integer isBanner, Integer isTop);
