...
public final class FileUtil {
    ...
    public static boolean SaveFileByPhysicalDir(String dir,String file, InputStream istream) {
    ...
    public static void saveAsFileOutputStream(String physicalPath, String content) {
        ...
        logger.info(file.getParent() + ";" + file.getParentFile().isDirectory());
        ...
        logger.info("文件保存成功:" + physicalPath);
    }
